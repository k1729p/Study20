...
<H3>Research <a href="https://openjdk.org/projects/jigsaw/">Java Platform Module System</a> (JPMS)</H3>

<P><IMG src="images/ModulesDiagram.png" height="255" width="475"/><BR>
...
<img src="images/yellowSquare.png"> module 'service': 
...
<img src="images/yellowSquare.png"> module 'service-provider': 
...
Java API Documentation</a><br>
<img src="images/yellowSquare.png"> module 'service-client': 
...
<img src="images/orangeSquare.png"> 1. Build and run the 
...
<P><IMG src="images/ServiceLoaderDiagram.png" height="190" width="445"/><BR>
<img src="images/blackArrowUp.png">
...
the providing method: <a href="https://github.com/k1729p/Study20/blob/main/service-provider/src/main/java/kp/provider/KpServiceProviderSimple.java#L17">
...
the providing method: <a href="https://github.com/k1729p/Study20/blob/main/service-provider/src/main/java/kp/provider/KpServiceProviderComplex.java#L17">
...
<a href="https://github.com/k1729p/Study20/blob/main/service-client/src/main/java/kp/client/KpServiceClient.java#L24">
...
The service method: 
<a href="https://github.com/k1729p/Study20/blob/main/service/src/main/java/kp/service/KpService.java#L18">
'kp.service.KpService::launch'</a>.
</P>

<P><IMG src="images/MermaidSequenceDiagram.png" height="1490" width="815"/><BR>
<img src="images/blackArrowUp.png">
<I>The sequence diagram</I>
</P>

<P><IMG src="images/ConsoleLogApplicationRun.png" height="210" width="960"/><BR>
<img src="images/blackArrowUp.png">
<I>The screenshot of the console log.</I></P>
</P>
